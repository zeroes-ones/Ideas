# Changelog — India Business OS (docs)
...
- **Decisions/state captured at this point:**
  - Positioning = two-sided (Entry A Launch Copilot → merchant OS · Entry B verified marketplace); badge = auto-derived, auto-hides (LM2).
  - Pilot = **Bengaluru + Hyderabad, both from day one, in parallel**; per-city ≥100 verified gate; city = config pack.
  - **OQ9 resolved → SaaS-first from business owners** (recurring subscription); price band/tiers open (H1–H6).
  - Individual providers (rung I): option set A–D captured, A recommended (OQ-I3/OQ-V2 open).
  - Research additions this session: bundler scan + Google Verified + Pincode retreat (competitive-map §4/§6); **Telangana Gig Workers Act 2026 in force ~15-Aug-2026** (1–2% levy) — corrected the earlier "draft-only" claim across docs; Hyderabad licence/S&E/gig partial web pass (hyderabad-pilot-map).
  - Partner artifacts: PARTNER-BRIEF (diagrams), partner-feedback-log, marketplace-audit, journey-flows (**40 scenarios, 8 per actor**).
- **Open (not resolved):** OQs 1–8, 10 · OQ-I1/I2/I3 · OQ-V1/V2/V3 · SaaS price band/tiers · W35 denominator run (Bengaluru) + W35b (Hyderabad) · H1–H6 interviews.
...
- **What:** …
- **Why:** …
- **Resolves/changes:** (which OQ / decision / doc)
- **Still open:** …
